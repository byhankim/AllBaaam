...
class CreateArticleActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        with (binding.themeSelectorRecyclerview) {
            ...
            testList.add(ThemeEntity(getString(R.string.comm_honey_tip), R.drawable.owll, R.color.style1_5, R.color.black, 1, false))
            ...
            testList.add(ThemeEntity(getString(R.string.comm_sports_overseas), R.drawable.owll, R.color.style1_3, R.color.black, 3, false))
            ...
            testList.add(ThemeEntity(getString(R.string.comm_study_hard), R.drawable.owll, R.color.style1_1, R.color.black, 5, false))
